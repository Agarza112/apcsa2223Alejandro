...
public class Java15_Arrays10062022
{
    public static void main(String[] args) {
        ...
        // default value of string is nll int is 0 boolean is false char is space

        int[] arr = {1,2,4,5,6,7,8,9}; // declaration of array
        ...
        System.out.println(arr); //this is not goint to print the rray values
        System.out.println(Arrays.toString(arr)); // we use arrays to string method to
        ...
        // S[LIT METHOD
        String stNames= "nathaniel alec chris Kris";
